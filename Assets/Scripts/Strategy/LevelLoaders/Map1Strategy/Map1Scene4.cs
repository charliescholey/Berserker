...
public class Map1Scene4 : MonoBehaviour
{
    ...
    void Awake()
    {
        ...
        // horizontal wall top 
        walls.AddRange(generateBox(new Vector2Int(-3, 4), new Vector2Int(9, 4)));

        // horizontal wall bottom 
        walls.AddRange(generateBox(new Vector2Int(-3, -5), new Vector2Int(9, -5)));

        //vertical wall on top
        walls.AddRange(generateBox(new Vector2Int(-3,3), new Vector2Int(-3,1)));

        //vertical wall on bottom
        walls.AddRange(generateBox(new Vector2Int(-3,-2), new Vector2Int(-3,-5)));
